        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="col-sm-6 co-sm-offset-3">
                        <form id="myForm" action="add_data.php" method="post">
                            <p>
                            <h3>Medice     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Quantity</h3>
            ...
            <div class="row" id="a">
                <form action="invoice.php" method="post">
                    <div class="col-sm-12">
                        <h3 class="text-center">Get Invoice</h3>   
                    ...
                    <div class="row"><div class="col-sm-4"></div>
                        <div class="col-sm-8">
                            <button type="submit" formtarget="_blank" name="recit" id="insert" class="btn btn-success">Continue</button>
                        </div>
