...
if(isset($_POST['done'])){
    ...
    $insertQuery="INSERT INTO `medicine_list`(`M_name`, `quantity`) VALUES ('$medicine_name', $quantity)";
                                                 ...
                                                 $seat_count=0; $total_price=0;   while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo $row['M_name'];
                                                            ...
                                                            echo '</td>';
                                                             ...
                                                             echo $p=$row['medicine_price']* $n; $total_price=$total_price+$p;
                                                             }
                                                            echo '</td>';
                                                             echo'<td> ';
                                                     ...
                                                     echo'<tr>';
                                                            ...
                                                            echo'<td colspan=2>';
                                                        echo '<strong>Selected Medicine: '.$seat_count, '</strong>';
                                                                echo'</td>';
                                                            echo'<td colspan=2>';
                                                                echo '<strong>Total: BDT '.$total_price, '</strong>';
                                                            echo '</td>';
                                                     echo'</tr>';
                                                    echo'</tbody>';
                                                echo'</table>';
